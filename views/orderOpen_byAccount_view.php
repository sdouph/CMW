...
<h2><?=anchor('/accounts/detail/'.$accountid, $account, $account);?> - Open Orders</h2><br />
...
$(document).ready(function() 
    { 
		...
		$("#openOrderList").jqGrid({
			url:'<?=site_url('orderOpen/ajaxGridByAccount/'.$accountid)?>',      //another controller function for generating XML data
		...
		$(window).resize(function() {
		 	$("#openOrderList").setGridHeight($(this).height()-260,true);
		});
